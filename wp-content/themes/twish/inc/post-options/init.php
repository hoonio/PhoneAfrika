...
function cmb_scripts($hook)
{
	...
	if ($hook == 'post.php' || $hook == 'post-new.php' || $hook == 'page-new.php' || $hook == 'page.php') {
		...
		wp_register_script('cmb-timepicker', CMB_META_BOX_URL . 'js/jquery.timePicker.min.js', false, true);
		wp_register_script('cmb-scripts', CMB_META_BOX_URL . 'js/cmb.js', $cmb_script_array, '0.9.1', true);
