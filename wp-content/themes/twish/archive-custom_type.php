		...
		<div id="main" class="eightcol first clearfix" role="main">
				...
				<article  <?php post_class('clearfix'); ?> role="article">
					...
					<header class="article-header">
						...
						<p class="byline vcard"><?php
							printf(__('Posted <time class="updated" datetime="%1$s">%2$s</time> by <span class="author">%3$s</span>.', 'adap'), get_the_time('Y-m-d'), get_the_time(__('F jS, Y', 'adap')), bones_get_the_author_posts_link());
							?></p>
			...
			<?php else : ?>
				...
				<article id="post-not-found" class="hentry clearfix">
					...
					<footer class="article-footer">
						<p><?php _e("This is the error message in the custom posty type archive template.", 'adap'); ?></p>
					</footer>
				</article>
