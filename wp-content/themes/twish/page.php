...
<div class="container">
	<div class="row">
		...
		<!-- Content
		================================================== -->
		<div class="<?php echo AdapThemeOptions::get_page_content_classes(); ?>" role="main">
		...
		<!-- Sidebar
		================================================== -->
		<?php if (AdapThemeOptions::show_page_sidebar()) { ?>
			<div class="<?php echo AdapThemeOptions::get_page_sidebar_classes(); ?> bs-docs-sidebar">
				<?php get_sidebar(); ?>
			</div>
		<?php } ?>
